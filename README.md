...
<ul style="">
    ...
    <li>clicking on the <code>CLEAR ALL</code> and <img src="/images/readme/trash_can.png" alt="Trash can"> buttons, a confirmation window pops up to confirm the removal of items</li>
